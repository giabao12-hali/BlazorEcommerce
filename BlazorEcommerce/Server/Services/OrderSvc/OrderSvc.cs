...
namespace BlazorEcommerce.Server.Services.OrderSvc
{
	public class OrderSvc : IOrderSvc
	{
		...
		public OrderSvc(DataContext context,
			ICartSvc cartSvc, IAuthSvc authSvc)
        {
			_context = context;
			_cartSvc = cartSvc;
			_authSvc = authSvc;
		...
		public async Task<ServiceResponse<OrderDetailsResponse>> GetOrderDetails(int orderId)
		{
			...
			var order = await _context.Orders
				...
				.Where(o => o.UserId == _authSvc.GetUserId() && o.Id == orderId)
		...
		public async Task<ServiceResponse<List<OrderOverviewResponse>>> GetOrders()
		{
			...
			var orders = await _context.Orders
				.Include(o => o.OrderItems)
				.ThenInclude(oi => oi.Product)
				.Where(o => o.UserId == _authSvc.GetUserId())
				.OrderByDescending(o => o.OrderDate)
				.ToListAsync();
		...
		public async Task<ServiceResponse<bool>> PlaceOrder()
		{
			...
			_context.CartItems.RemoveRange(_context.CartItems
				.Where(ci => ci.UserId == _authSvc.GetUserId()));
